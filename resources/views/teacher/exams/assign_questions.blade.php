...
<div class="page-header">
  ...
  <a href="{{ route('teacher.exams.index') }}" class="btn btn-outline">← Back to Exams</a>
</div>
...
<div class="drag-container">
    ...
    <div class="drag-column assigned-col">
        ...
        <form method="POST" action="{{ route('teacher.exams.questions.assign.store', $exam) }}" style="margin-top:20px" onsubmit="prepareSubmit()">
            @csrf
